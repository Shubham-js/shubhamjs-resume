    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative z-10">
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200 dark:border-gray-800 mb-8 shadow-sm">
          ...
          {/* Subtitle */}
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-600 dark:text-gray-400 mb-8">
            {portfolioData.title}
          </h2>
          ...
          <div className="mt-16 flex justify-center gap-6">
            {portfolioData.socialLinks.map((social, idx) => {
              ...
              const getSocialColor = (iconName: string) => {
                const colors: Record<string, { hover: string; default: string }> = {
                  github: {
                    hover: "hover:bg-gray-900 dark:hover:bg-gray-100 hover:text-white dark:hover:text-gray-900",
                ...
                return colors[iconName.toLowerCase()] || {
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute inset-0 rounded-xl bg-gradient-to-br opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm ${
                    social.icon.toLowerCase() === 'github' ? 'from-gray-800 to-gray-900' :
                    social.icon.toLowerCase() === 'linkedin' ? 'from-blue-600 to-blue-700' :
                    social.icon.toLowerCase() === 'twitter' ? 'from-blue-400 to-blue-500' :
                  ...
                  {/* Pulse animation */}
                  <div className={`absolute inset-0 rounded-xl border-2 opacity-0 group-hover:opacity-100 animate-ping ${
                    social.icon.toLowerCase() === 'github' ? 'border-gray-800' :
                    social.icon.toLowerCase() === 'linkedin' ? 'border-blue-600' :
                    social.icon.toLowerCase() === 'twitter' ? 'border-blue-400' :
                    'border-purple-600'
                  }`} />
                </a>
              );
